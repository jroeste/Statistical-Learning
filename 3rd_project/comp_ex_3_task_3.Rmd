...
Between countries, we see that Great Britain and Ireland, which are closely located, have the same drinking habits and opinions about tea. Countries like Italy, France and Portugal have negative scores on the first component, with opposite meaning of drinking tea. Also, the loading vector for tea is longer than he one for liquer, which means the opinions about tea is stronger for countries as Great Britain and Ireland, than for Hungary and the Soviet Union. 

Since the Netherlands has a large positive scoreon the first component, we can assume that they have very strong opinions about cocoa.
