...
\includegraphics{project2_MASTER_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\CommentTok{#"Anderson-Darling normality test"}
\CommentTok{#ad.test(rstudent(ourAutofit.lm))}
\end{Highlighting}
\end{Shaded}
