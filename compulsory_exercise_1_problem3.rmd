...
```{r, echo=FALSE}
>>>>>>> 332fc9404998211e691dc0694c7a57390cc3b665
library(ggplot2)
library(GGally)
library(class)
library(MASS)
...
gives the probability that a test observation with predictor values $x_0$ has response value $Y=1$. This probability
