...
An ROC curve compares the sensitivity and specificity up against each other. A specificity equal 1 will give sensitivity equal 0, and the other way around. It is useful to have because it gives a graphical to evalute which classification method is the best when comparing sensitivity and specificity. 
```{r, eval=FALSE}
library(pROC)
