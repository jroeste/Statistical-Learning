...
????
The most important difference between the LDA and the QDA philosophy is that the covariance matrices are different for QDA and assumes equal for LDA. In our task we got different ???

###Task d)
When comparing 


Explain what an ROC curve is. 
```{r, eval=FALSE}
library(pROC)
